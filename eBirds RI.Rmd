...
```{r}
(weekapaug_df <- get_bird_sightings('https://ebird.org/hotspot/L620475?yr=all&m=&rank=hc'))
(washington_county_df = get_bird_sightings('https://ebird.org/subnational2/US-RI-009?yr=all&m=&rank=hc'))
...
get_count_per_season_for_year_range(rhode_island_df, 2010, 2019) %>%
  filter(season=="fall")

rhode_island_df %>%
  filter(date >= as.Date("2012-08-01") & date < as.Date("2012-12-01"))

washington_county_df %>%
  filter(date >= as.Date("2012-08-01") & date < as.Date("2012-12-01"))

rhode_island_df %>%
  filter(date >= as.Date("2012-01-01" & date < as.Date("2013-01-01")))

washington_county_df %>%
  filter(name == "Red Crossbill")
